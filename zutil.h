...
typedef void *zcalloc_func(void *opaque, unsigned items, unsigned size);
typedef void  zcfree_func(void *opaque, void *ptr);

void Z_INTERNAL *PREFIX(zalloc_aligned)(zcalloc_func calloc, void *opaque, unsigned items, unsigned size, unsigned align);
void Z_INTERNAL  PREFIX(zfree_aligned)(zcfree_func cfree, void *opaque, void *ptr);

#define ZALLOC(strm, items, size) PREFIX(zalloc_aligned)((strm)->zalloc, (strm)->opaque, (items), (size), 64)
#define ZFREE(strm, addr)         PREFIX(zfree_aligned)((strm)->zfree, (strm)->opaque, (void *)(addr))
