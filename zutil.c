...
#ifdef ZLIB_COMPAT
const char zlibng_string_compat[] =
    " zlib-ng 2.1.0.devel compat API forked from zlib";
...
const char zlibng_string[] =
    " zlib-ng 2.1.0.devel native API forked from zlib";
...
void Z_INTERNAL *PREFIX(zalloc_aligned)(zcalloc_func zalloc, void *opaque, unsigned items, unsigned size, unsigned align) {
...
void Z_INTERNAL PREFIX(zfree_aligned)(zcfree_func zfree, void *opaque, void *ptr) {
